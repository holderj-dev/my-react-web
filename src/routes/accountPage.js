                ...
                <div class="border rounded-lg shadow-xl bg-gray-50 lg:w-1/2">
                    <div class="m-4">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <input type='file' onChange={handleImageSwap} />
                        </div>
                    </div>
                    <div class="flex p-2 space-x-4">
                        ...
                        <button onClick={handleSubmit} type='button' class="px-4 py-2 text-white bg-green-500 border rounded shadow-xl">Create</button>
